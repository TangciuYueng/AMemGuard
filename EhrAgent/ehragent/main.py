...
def main():
    ...
    parser.add_argument("--num_lessons", type=int, default=4)
    ...
    user_proxy = MedAgent(
        ...
        enable_memory_audit=args.audit_method,
    ...
    save_file_name = f"{attack_algorithm}_{flag}_{embedder_identifier}_{timestamp}.json"
    full_file_path = os.path.join(args.save_dir, args.backbone, save_file_name)
